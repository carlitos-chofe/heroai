...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("preference_summary", postgresql.JSONB(), nullable=False, server_default="'{}'::jsonb"),
        sa.Column("created_at", sa.TIMESTAMP(), nullable=False, server_default=sa.text("NOW()")),
    ...
    op.create_table(
        ...
        sa.Column("generation_status", sa.String(40), nullable=False, server_default="'pending'"),
        sa.Column("created_at", sa.TIMESTAMP(), nullable=False, server_default=sa.text("NOW()")),
        sa.Column("updated_at", sa.TIMESTAMP(), nullable=False, server_default=sa.text("NOW()")),
